...
//        track.commit();
    ...
    @Override
    public Repository getBlockchainRepository() {
    ...
    class SolidityStorageImpl implements SolidityStorage {
        ...
        public SolidityStorageImpl(byte[] address) {
            this.details = getBlockchain().getRepository().getContractDetails(address);
        }

        @Override
        public int size() {
            return details.getStorageSize();
        }

        @Override
        public Set<DataWord> keySet() {
            return details.getStorageKeys();
        }
        ...
        @Override
        public Map<DataWord, DataWord> get(List<DataWord> keys) {
            return details.getStorage(keys);
        }
    }
}
